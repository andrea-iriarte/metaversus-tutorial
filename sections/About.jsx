  ...
  <section className={`${styles.paddings} relative z-10` }>
    ...
    flex-col`}>
      ...
      text-[20px] text-center text-secondary-white ">
        ...
        className="text-white">Metaverse </span> 
        ...
        <span style={{ fontWeight: '800'}}
        className="text-white"> the madness of the metaverse </span> 
        
        of today, using only 
        
        <span style={{ fontWeight: '800'}}
        className="text-white"> VR </span>
        
        devices you can easily 
        
        <span style={{ fontWeight: '800'}}
        className="text-white"> explore </span> 
        
        the metaverse world you want, 
        turn your dreams into reality. Let's explore the madness of the 
